...
var View = React.createClass({
	...
	renderCreateForm: function() {
		...
		return <CreateForm tenant={Keystone.tenant} list={Keystone.list} animate={this.state.animateCreateForm} onCancel={this.toggleCreate.bind(this, false)} values={Keystone.createFormData} err={Keystone.createFormErrors} />
	},
