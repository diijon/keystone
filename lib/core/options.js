...
function options() {
	...
	exports.set = function(key, value) {
		...
		switch (key) {
			case 'multitenant map':
				this.multitenantMap = value || {};
			break;
			case 'multitenant find':
				this.multitenantFind = value || function(req, res, next){ return false; }
			break;
			case 'multitenant default':
				this.multitenantDefault = value;
			break;
